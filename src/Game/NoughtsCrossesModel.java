...
/**
 * The model of the NoughtsCrosses game
...
public class NoughtsCrossesModel extends Observable {
	...
	/**
	 * Returns the string of the symbol at the given location 
	 * @param i the row
	 * @param j the column
	 * @return String The string of the symbol at the given location
	 */
